        ...
        <form method="POST">
            <div class="row">
                <div class="mb-3 col-12">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value=<?php echo $leaveResults['leave_name'] ?> required>
                </div>
                <div class="mb-3 col-12">
                    <label for="attocation" class="form-label">Allocation</label>
                    <input type="number" class="form-control" id="allocation" name="allocation" value=<?php echo $leaveResults['default_allocation'] ?> required>
                </div>
            </div>
